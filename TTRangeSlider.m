...
- (void)initialiseControl {
    ...
    self.leftHandle.backgroundColor = self.minLabelColour.CGColor;
    ...
    self.rightHandle.backgroundColor = self.maxLabelColour.CGColor;
...
- (void)updateHandlePositions {
    ...
    self.sliderLineBetweenHandles.frame = CGRectMake(self.leftHandle.position.x, self.sliderLine.frame.origin.y, self.rightHandle.position.x-self.leftHandle.position.x, 1.0);
}
...
-(void)setMinLabelColour:(UIColor *)minLabelColour{
    ...
    self.leftHandle.backgroundColor = _minLabelColour.CGColor;
...
-(void)setMaxLabelColour:(UIColor *)maxLabelColour{
    ...
    self.maxLabel.foregroundColor = _maxLabelColour.CGColor;
     self.rightHandle.backgroundColor = _maxLabelColour.CGColor;
}
