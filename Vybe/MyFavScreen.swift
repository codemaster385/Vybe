...
class MyFavScreenCell: UITableViewCell {
...
class MyFavScreen:UIViewController {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier("cellIdentifier", forIndexPath: indexPath) as! MyFavScreenCell
